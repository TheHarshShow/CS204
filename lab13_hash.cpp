...
bool hash_table[5][10000019];


void insert(string s, ll primes[]){
    ...
    REP(i,0,5){
        ...
        hash_table[i][ans%10000019]=true;
...
bool search(string s, ll primes[]){
    ...
    REP(i,0,5){
        ...
        if(hash_table[i][ans%10000019] == false){flag=1;break;}
...
int main(){
    ...
    REP(i,0,n){
        ...
        if(s==arr[i])continue;
        if(search(arr[i], primes)){cout<<"YES"<<endl;return 0;}
